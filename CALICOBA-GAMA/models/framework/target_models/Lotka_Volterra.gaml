...
species TargetModel skills: [calicoba_target_model] {
  ...
  obj_def obj_preys_number <- obj_def(["out_preys_var", 50.0, 150.0, 250.0]);
  obj_def obj_predators_number <- obj_def(["out_predators_var", 0.0, 50.0, 90.0]);
...
//  ];
  ...
  equation lotka_volterra {
    ...
    diff(out_predators_number, t) = -out_predators_number * (param_predators_death_rate - param_predation_efficiency * out_preys_number);
  }
