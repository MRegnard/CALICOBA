...
class Scenario4Test {
  ...
  static void setUpBeforeClass() {
    ...
    calicoba.addObjective("obj2", new CriticalityFunctionParameters(-4, -3, -2, -1, 0, 1), "param");
    calicoba.setup();
  ...
  void test() {
    calicoba.step();
    Assertions.assertEquals(ParameterAgent.State.DIFFERENT_DIRECTIONS, param.getState());
