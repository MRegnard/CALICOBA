...
_action((s,a,t,v)->{((fr.irit.smac.calicoba.gaml.skills.GlobalSkill) t).init(s);return null;},desc(PRIM,new Children(desc(ARG,NAME,"step_interval",TYPE,"1","optional",FALSE)),NAME,"calicoba_init",TYPE,Ti(void.class),VIRTUAL,FALSE),fr.irit.smac.calicoba.gaml.skills.GlobalSkill.class.getMethod("init",SC));
