...
class PointAgentTest(unittest.TestCase):
    def setUp(self):
        ...
        self.world = calicoba.Calicoba(calicoba.CalicobaConfig())
        self.world.add_parameter(self.input)
        self.param = self.world.get_agents_for_type(calicoba.agents.ParameterAgent)[0]
    ...
    def test_1_previous__proceed(self):
        agent1 = calicoba.agents.PointAgent('p_1', self.param, None, {'o': 0.5})
    ...
    def test_2_previous__follow_slope(self):
        ...
        self.input.set_data(1)
        self.param.perceive()
        agent3 = calicoba.agents.PointAgent('p_3', self.param, agent2, {'o': 0.3})
        self.world.add_agent(agent1)
        self.world.add_agent(agent2)
    ...
    def test_2_previous__go_to_middle(self):
        ...
        self.input.set_data(1)
        self.param.perceive()
        agent3 = calicoba.agents.PointAgent('p_3', self.param, agent2, {'o': 0.6})
        self.world.add_agent(agent1)
        self.world.add_agent(agent2)
        self.world.add_agent(agent3)
        agent3.decide()
